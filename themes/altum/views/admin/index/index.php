            ...
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.tools_views') ?></small>
                    </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/statistics/tools_views') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->tools->views) ?></span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.tools_submissions') ?></small>
                    </div>

                    <div class="col-auto">
                        <span class="p-2 bg-primary-100 rounded">
                            <i class="fas fa-fw fa-sm fa-plus text-primary"></i>
                        </span>
                    </div>
                </div>

                <div class="mt-2 text-break">
                    <a href="<?= url('admin/statistics/tools_submissions') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->tools->submissions) ?></span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.tools_ratings') ?></small>
                    </div>

                    <div class="col-auto">
                        <span class="p-2 bg-primary-100 rounded">
                            <i class="fas fa-fw fa-sm fa-sort-numeric-up-alt text-primary"></i>
                        </span>
                    </div>
                </div>

                <div class="mt-2 text-break">
                    <a href="<?= url('admin/statistics/tools_ratings') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->tools->ratings) ?></span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.tools_average_rating') ?></small>
                    </div>

                    <div class="col-auto">
                        <span class="p-2 bg-primary-100 rounded">
                            <i class="fas fa-fw fa-sm fa-star text-primary"></i>
                        </span>
                    </div>
                </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/statistics/tools_ratings') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->tools->average_rating, 2, false) ?></span>
                    </a>
                </div>
            </div>
        </div>
