    ...
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-4">
        <div class="d-xl-none">
            <select name="settings_menu" class="custom-select">
                ...
                <option value="<?= url('admin/settings/image_optimizer') ?>" class="nav-link" <?= $data->method == 'image_optimizer' ? 'selected="selected"' : null ?>><?= l('admin_settings.image_optimizer.tab') ?></option>
