...
<div>
    ...
    <div class="form-group">
        ...
        <textarea id="welcome_js" name="welcome_js" class="form-control"><?= settings()->custom->welcome_js ?></textarea>
    ...
    <div class="form-group">
        ...
        <textarea id="pay_thank_you_js" name="pay_thank_you_js" class="form-control"><?= settings()->custom->pay_thank_you_js ?></textarea>
