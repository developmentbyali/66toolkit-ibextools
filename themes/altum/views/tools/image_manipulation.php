...
<div class="container">
    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            ...
            <?php endif ?>
                <li class="active" aria-current="page"><?= sprintf(l('tools.image_manipulation_tools.name'), l('tools.' . $data->from), l('tools.' . $data->to)) ?></li>
            </ol>
        </nav>
    <?php endif ?>
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><?= sprintf(l('tools.image_manipulation_tools.name'), l('tools.' . $data->from), l('tools.' . $data->to)) ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= sprintf(l('tools.image_manipulation_tools.description'), l('tools.' . $data->from), l('tools.' . $data->to)) ?>">
