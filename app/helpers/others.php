...
function fire_and_forget($method, $url, $params = []) {
    ...
    $hostWithScheme = ($scheme === 'https' ? 'ssl://' : '') . $host;
    $socket = @fsockopen($hostWithScheme, $port, $errno, $errstr, 5);
