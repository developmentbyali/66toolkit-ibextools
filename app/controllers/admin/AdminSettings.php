...
class AdminSettings extends Controller {
    ...
    public function smtp() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['button_background_color'] = !preg_match('/#([A-Fa-f0-9]{3,4}){1,2}\b/i', $_POST['button_background_color']) ? '#000000' : $_POST['button_background_color'];
            $_POST['button_text_color'] = !preg_match('/#([A-Fa-f0-9]{3,4}){1,2}\b/i', $_POST['button_text_color']) ? '#000000' : $_POST['button_text_color'];
    ...
    public function tools() {
        ...
        if(!empty($_POST)) {
            ...
            foreach($tools as $key => $value) {
                ...
                if($available_tools[$key]) $available_tools_count++;
            }
