...
return [
    ...
    'admin_settings.tools.categories_collapsible_is_enabled' => 'Make categories collapsible',
    'admin_settings.tools.categories_collapsible_is_enabled_help' => 'If enabled, categories on the index page will be rendered collapsible and can be toggled by the user.',

    'admin_settings.tools.category_collapsible' => 'Collapsible for this category',
   ...
   'plan.why.one.subheader' => 'Get fast, friendly help from our expert support team whenever you need it.',
	'plan.why.two.header' => 'Privacy',
	'plan.why.two.subheader' => 'Your data is private and always under your control.',
	'plan.why.three.header' => 'Quality',
	'plan.why.three.subheader' => 'We deliver top quality and value your time with a smooth experience.',

    'plan.faq.header' => 'Frequently asked questions',
    'plan.faq.one.question' => 'What forms of payment do you accept?',
    'plan.faq.one.answer' => 'We accept payments via credit cards, debit cards, and many other payment methods depending on the payment processor you choose during checkout.',
    ...
    'index.testimonials.header' => 'What our users say about us',
    'index.testimonials.one.text' => 'This toolkit makes my workflow so much easier. Highly recommended for anyone working online.',
    'index.testimonials.one.name' => 'Samantha Lee',
    'index.testimonials.one.attribute' => 'Web Designer',
    'index.testimonials.two.text' => 'A fantastic set of tools that saves me time every day. The interface is clean and simple.',
    'index.testimonials.two.name' => 'David Kim',
    'index.testimonials.two.attribute' => 'Digital Marketer',
    'index.testimonials.three.text' => 'Reliable, fast, and easy to use. I use these tools for all my web projects.',
    'index.testimonials.three.name' => 'Priya Patel',
    'index.testimonials.three.attribute' => 'Software Engineer',

    'index.faq.header' => '%1$sAnswers%2$s for your common %1$squestions%2$s',
    'index.faq.one.question' => 'Are these tools free to use?',
    'index.faq.one.answer' => 'Yes, all our online tools are free and accessible to everyone without registration.',
    'index.faq.two.question' => 'Do I need to install anything to use the tools?',
    'index.faq.two.answer' => 'No installation is required. All tools work directly in your browser.',
    'index.faq.three.question' => 'Is my data safe when using these tools?',
    'index.faq.three.answer' => 'Absolutely. We do not store or share any data you process with our tools.',
    'index.faq.four.question' => 'Can I use these tools on mobile devices?',
    'index.faq.four.answer' => 'Yes, our tools are fully responsive and work on smartphones and tablets.',
    ...
    'tools.checker_tools' => 'Check & Verify Tools',
    'tools.checker_tools_help' => 'Handy tools for checking and verifying domains, IPs, and more.',
    'tools.text_tools' => 'Text Editing Tools',
    'tools.text_tools_help' => 'Tools to create, edit, and enhance your text content.',
    'tools.converter_tools' => 'Data Converter Tools',
    'tools.converter_tools_help' => 'Convert data between formats quickly and easily.',
    'tools.generator_tools' => 'Data Generator Tools',
    'tools.generator_tools_help' => 'Generate random data, passwords, and more in seconds.',
    'tools.developer_tools' => 'Developer Utilities',
    'tools.developer_tools_help' => 'Essential tools for developers to test, debug, and optimize.',
    'tools.image_manipulation_tools' => 'Image Tools',
    'tools.image_manipulation_tools_help' => 'Edit, convert, and optimize images with ease.',
    'tools.misc_tools' => 'Miscellaneous Tools',
    'tools.misc_tools_help' => 'Useful extra tools for various web tasks.',
    'tools.unit_converter_tools' => 'Unit Conversion Tools',
    'tools.unit_converter_tools_help' => 'Convert between common units for everyday needs.',
    'tools.time_converter_tools' => 'Time Conversion Tools',
    'tools.time_converter_tools_help' => 'Convert and calculate dates and times easily.',
    'tools.data_converter_tools' => 'Data Size Converter Tools',
    'tools.data_converter_tools_help' => 'Convert computer data sizes and formats.',
    'tools.length_converter_tools' => 'Length Converter Tools',
    'tools.length_converter_tools_help' => 'Convert between different length units easily.',
    'tools.weight_converter_tools' => 'Weight Converter Tools',
    'tools.weight_converter_tools_help' => 'Convert between different weight units quickly.',
    'tools.volume_converter_tools' => 'Volume Converter Tools',
    'tools.volume_converter_tools_help' => 'Convert between different volume units easily.',
    'tools.area_converter_tools' => 'Area Converter Tools',
    'tools.area_converter_tools_help' => 'Convert between different area units quickly.',
    'tools.force_converter_tools' => 'Force Converter Tools',
    'tools.force_converter_tools_help' => 'Convert between different force units easily.',
    'tools.color_converter_tools' => 'Color Conversion Tools',
    'tools.color_converter_tools_help' => 'Convert colors between HEX, RGB, HSL, and more.',
    ...
    'tools.color_converter_tools.name' => '%1$s Color Converter',
    'tools.color_converter_tools.description' => 'Convert %1$s colors to %2$s format quickly and simply.',
    ...
    'tools.image_manipulation_tools.name' => '%1$s Image Converter',
    'tools.image_manipulation_tools.description' => 'Transform %1$s images to %2$s format with a single click.',
    ...
    'tools.dns_lookup.description' => 'Easily view all DNS records for any domain.',
    ...
    'tools.ip_lookup.name' => 'IP Info',
    'tools.ip_lookup.description' => 'Get clear details about any IP address.',
    ...
    'tools.reverse_ip_lookup.description' => 'Find domains linked to an IP address instantly.',
    ...
    'tools.ssl_lookup.name' => 'SSL Certificate Info',
    'tools.ssl_lookup.description' => 'View SSL certificate details for any website.',
    ...
    'tools.whois_lookup.description' => 'Check domain registration and status information.',
    ...
    'tools.ping.name' => 'Ping Test',
    'tools.ping.description' => 'Test website or server connection speed and status.',
    ...
    'tools.md5_generator.name' => 'MD5 Hash Generator',
    'tools.md5_generator.description' => 'Create an MD5 hash from any text input.',
    'tools.md5_generator.meta_keywords' => '',
    'tools.md5_generator.result' => 'MD5 Hash',
    'tools.md5_generator.extra_content' => '',

    'tools.md2_generator.name' => 'MD2 Hash Generator',
    'tools.md2_generator.description' => 'Create an MD2 hash from any text input.',
    'tools.md2_generator.meta_keywords' => '',
    'tools.md2_generator.result' => 'MD2 Hash',
    'tools.md2_generator.extra_content' => '',

    'tools.md4_generator.name' => 'MD4 Hash Generator',
    'tools.md4_generator.description' => 'Create an MD4 hash from any text input.',
    'tools.md4_generator.meta_keywords' => '',
    'tools.md4_generator.result' => 'MD4 Hash',
    'tools.md4_generator.extra_content' => '',

    'tools.whirlpool_generator.name' => 'Whirlpool Hash Generator',
    'tools.whirlpool_generator.description' => 'Create a Whirlpool hash from any text input.',
    ...
    'tools.sha1_generator.name' => 'SHA-1 Hash Generator',
    'tools.sha1_generator.description' => 'Create a SHA-1 hash from any text input.',
    'tools.sha1_generator.meta_keywords' => '',
    'tools.sha1_generator.result' => 'SHA-1 Hash',
    'tools.sha1_generator.extra_content' => '',

    'tools.sha224_generator.name' => 'SHA-224 Hash Generator',
    'tools.sha224_generator.description' => 'Create a SHA-224 hash from any text input.',
    'tools.sha224_generator.meta_keywords' => '',
    'tools.sha224_generator.result' => 'SHA-224 Hash',
    'tools.sha224_generator.extra_content' => '',

    'tools.sha256_generator.name' => 'SHA-256 Hash Generator',
    'tools.sha256_generator.description' => 'Create a SHA-256 hash from any text input.',
    'tools.sha256_generator.meta_keywords' => '',
    'tools.sha256_generator.result' => 'SHA-256 Hash',
    'tools.sha256_generator.extra_content' => '',

    'tools.sha384_generator.name' => 'SHA-384 Hash Generator',
    'tools.sha384_generator.description' => 'Create a SHA-384 hash from any text input.',
    'tools.sha384_generator.meta_keywords' => '',
    'tools.sha384_generator.result' => 'SHA-384 Hash',
    'tools.sha384_generator.extra_content' => '',

    'tools.sha512_generator.name' => 'SHA-512 Hash Generator',
    'tools.sha512_generator.description' => 'Create a SHA-512 hash from any text input.',
    'tools.sha512_generator.meta_keywords' => '',
    'tools.sha512_generator.result' => 'SHA-512 Hash',
    'tools.sha512_generator.extra_content' => '',

    'tools.sha512_224_generator.name' => 'SHA-512/224 Hash Generator',
    'tools.sha512_224_generator.description' => 'Create a SHA-512/224 hash from any text input.',
    ...
    'tools.sha512_256_generator.name' => 'SHA-512/256 Hash Generator',
    'tools.sha512_256_generator.description' => 'Create a SHA-512/256 hash from any text input.',
    ...
    'tools.sha3_224_generator.name' => 'SHA-3/224 Hash Generator',
    'tools.sha3_224_generator.description' => 'Create a SHA-3/224 hash from any text input.',
    ...
    'tools.sha3_256_generator.name' => 'SHA-3/256 Hash Generator',
    'tools.sha3_256_generator.description' => 'Create a SHA-3/256 hash from any text input.',
    ...
    'tools.sha3_384_generator.name' => 'SHA-3/384 Hash Generator',
    'tools.sha3_384_generator.description' => 'Create a SHA-3/384 hash from any text input.',
    ...
    'tools.sha3_512_generator.name' => 'SHA-3/512 Hash Generator',
    'tools.sha3_512_generator.description' => 'Create a SHA-3/512 hash from any text input.',
    ...
    'tools.ripemd128_generator.name' => 'RIPEMD128 Hash Generator',
    'tools.ripemd128_generator.description' => 'Create a RIPEMD128 hash from any text input.',
    ...
    'tools.ripemd160_generator.name' => 'RIPEMD160 Hash Generator',
    'tools.ripemd160_generator.description' => 'Create a RIPEMD160 hash from any text input.',
    ...
    'tools.ripemd256_generator.name' => 'RIPEMD256 Hash Generator',
    'tools.ripemd256_generator.description' => 'Create a RIPEMD256 hash from any text input.',
    ...
    'tools.ripemd320_generator.name' => 'RIPEMD320 Hash Generator',
    'tools.ripemd320_generator.description' => 'Create a RIPEMD320 hash from any text input.',
    ...
    'tools.base64_encoder.name' => 'Base64 Text Encoder',
    'tools.base64_encoder.description' => 'Easily encode text to Base64 for safe sharing and storage.',
    'tools.base64_encoder.meta_keywords' => '',
    'tools.base64_encoder.result' => 'Base64 encoded',
    'tools.base64_encoder.extra_content' => '',

    'tools.base64_decoder.name' => 'Base64 Text Decoder',
    'tools.base64_decoder.description' => 'Quickly decode Base64 back to plain text.',
    'tools.base64_decoder.meta_keywords' => '',
    'tools.base64_decoder.result' => 'Base64 decoded',
    'tools.base64_decoder.extra_content' => '',

    'tools.base64_to_image.name' => 'Base64 Image Converter',
    'tools.base64_to_image.description' => 'Transform Base64 code into a viewable image.',
    'tools.base64_to_image.meta_keywords' => '',
    'tools.base64_to_image.result' => 'Image',
    'tools.base64_to_image.extra_content' => '',

    'tools.image_to_base64.name' => 'Image to Base64 Converter',
    'tools.image_to_base64.description' => 'Encode images to Base64 for easy embedding.',
    'tools.image_to_base64.meta_keywords' => '',
    'tools.image_to_base64.result' => 'Base64 encoded',
    'tools.image_to_base64.extra_content' => '',

    'tools.url_encoder.name' => 'URL Text Encoder',
    'tools.url_encoder.description' => 'Encode text for safe and valid URLs.',
    'tools.url_encoder.meta_keywords' => '',
    'tools.url_encoder.result' => 'URL encoded',
    'tools.url_encoder.extra_content' => '',

    'tools.url_decoder.name' => 'URL Text Decoder',
    'tools.url_decoder.description' => 'Decode URL-encoded text back to readable text.',
    'tools.url_decoder.meta_keywords' => '',
    'tools.url_decoder.result' => 'URL decoded',
    'tools.url_decoder.extra_content' => '',

    'tools.lorem_ipsum_generator.name' => 'Dummy Text Generator',
    'tools.lorem_ipsum_generator.description' => 'Generate placeholder text for layouts and mockups.',
    ...
    'tools.markdown_to_html.name' => 'Markdown to HTML Tool',
    'tools.markdown_to_html.description' => 'Easily convert Markdown to clean HTML.',
    ...
    'tools.case_converter.name' => 'Text Case Changer',
    'tools.case_converter.description' => 'Switch text between lowercase, UPPERCASE, camelCase, and more.',
    ...
    'tools.random_number_generator.name' => 'Random Number Picker',
    'tools.random_number_generator.description' => 'Pick a random number from any range you set.',
    ...
    'tools.uuid_v4_generator.name' => 'Unique ID Generator',
    'tools.uuid_v4_generator.description' => 'Generate universally unique identifiers (UUID v4).',
    'tools.uuid_v4_generator.meta_keywords' => '',
    'tools.uuid_v4_generator.result' => 'UUID v4',
    'tools.uuid_v4_generator.extra_content' => '',

    'tools.bcrypt_generator.name' => 'Bcrypt Password Hasher',
    'tools.bcrypt_generator.description' => 'Create secure bcrypt hashes for passwords.',
    'tools.bcrypt_generator.meta_keywords' => '',
    'tools.bcrypt_generator.result' => 'Bcrypt Hash',
    'tools.bcrypt_generator.extra_content' => '',

    'tools.password_generator.name' => 'Secure Password Generator',
    'tools.password_generator.description' => 'Generate strong, custom passwords for any need.',
    ...
    'tools.password_strength_checker.name' => 'Password Security Tester',
    'tools.password_strength_checker.description' => 'Test your password for strength and safety.',
    ...
    'tools.slug_generator.name' => 'URL Slug Maker',
    'tools.slug_generator.description' => 'Make SEO-friendly slugs from any text.',
    'tools.slug_generator.meta_keywords' => '',
    'tools.slug_generator.result' => 'Slug',
    'tools.slug_generator.extra_content' => '',

    'tools.html_minifier.name' => 'HTML Compressor',
    'tools.html_minifier.description' => 'Minify HTML code for faster websites.',
    ...
    'tools.css_minifier.name' => 'CSS Compressor',
    'tools.css_minifier.description' => 'Minify CSS code for faster page loads.',
    ...
    'tools.js_minifier.name' => 'JavaScript Compressor',
    'tools.js_minifier.description' => 'Minify JavaScript code for better performance.',
    ...
    'tools.user_agent_parser.name' => 'Browser Info Extractor',
    'tools.user_agent_parser.description' => 'Extract browser, OS, and device info from user agent strings.',
    ...
    'tools.website_hosting_checker.name' => 'Web Host Finder',
    'tools.website_hosting_checker.description' => 'Discover the hosting provider for any website.',
    ...
    'tools.file_mime_type_checker.name' => 'File Info Checker',
    'tools.file_mime_type_checker.description' => 'Get file type, size, and last modified details.',
    ...
    'tools.gravatar_checker.name' => 'Gravatar Finder',
    'tools.gravatar_checker.description' => 'Find the avatar linked to any email address.',
    ...
    'tools.character_counter.name' => 'Text Counter',
    'tools.character_counter.description' => 'Count characters, words, and lines in your text.',
    ...
    'tools.list_randomizer.name' => 'List Shuffler',
    'tools.list_randomizer.description' => 'Shuffle any list of text for random order.',
    'tools.list_randomizer.meta_keywords' => '',
    'tools.list_randomizer.result' => 'Randomized',
    'tools.list_randomizer.extra_content' => '',

    'tools.reverse_words.name' => 'Word Reverser',
    'tools.reverse_words.description' => 'Flip the order of words in your sentence or paragraph.',
    'tools.reverse_words.meta_keywords' => '',
    'tools.reverse_words.result' => 'Reversed',
    'tools.reverse_words.extra_content' => '',

    'tools.reverse_letters.name' => 'Letter Reverser',
    'tools.reverse_letters.description' => 'Reverse the letters in your text easily.',
    'tools.reverse_letters.meta_keywords' => '',
    'tools.reverse_letters.result' => 'Reversed',
    'tools.reverse_letters.extra_content' => '',

    'tools.emojis_remover.name' => 'Emoji Remover',
    'tools.emojis_remover.description' => 'Remove emojis from any text instantly.',
    'tools.emojis_remover.meta_keywords' => '',
    'tools.emojis_remover.result' => 'Text without emojis',
    'tools.emojis_remover.extra_content' => '',

    'tools.reverse_list.name' => 'List Reverser',
    'tools.reverse_list.description' => 'Reverse the order of lines in your list.',
    'tools.reverse_list.meta_keywords' => '',
    'tools.reverse_list.result' => 'Reversed',
    'tools.reverse_list.extra_content' => '',

    'tools.list_alphabetizer.name' => 'Alphabetize List',
    'tools.list_alphabetizer.description' => 'Sort your list alphabetically, A-Z or Z-A.',
    'tools.list_alphabetizer.meta_keywords' => '',
    'tools.list_alphabetizer.result' => 'Alphabetized',
    'tools.list_alphabetizer.extra_content' => '',

    'tools.upside_down_text_generator.name' => 'Upside Down Text',
    'tools.upside_down_text_generator.description' => 'Flip your text upside down for fun effects.',
    ...
    'tools.old_english_text_generator.name' => 'Old English Text',
    'tools.old_english_text_generator.description' => 'Transform text into an Old English style.',
    ...
    'tools.cursive_text_generator.name' => 'Cursive Text',
    'tools.cursive_text_generator.description' => 'Convert your text to a cursive font style.',
    ...
    'tools.palindrome_checker.description' => 'Check if your word or phrase is a palindrome.',
    'tools.palindrome_checker.meta_keywords' => '',
    'tools.palindrome_checker.extra_content' => '',

    'tools.url_parser.name' => 'URL Analyzer',
    'tools.url_parser.description' => 'Break down any URL into its components.',
    ...
    'tools.color_converter.name' => 'Color Format Converter',
    'tools.color_converter.description' => 'Change your color between HEX, RGB, and more.',
    ...
    'tools.http_headers_lookup.name' => 'HTTP Headers Viewer',
    'tools.http_headers_lookup.description' => 'View and analyze HTTP headers for any site.',
    ...
    'tools.http2_checker.name' => 'HTTP/2 Status',
    'tools.http2_checker.description' => 'See if a website supports HTTP/2 protocol.',
    ...
    'tools.brotli_checker.name' => 'Brotli Compression Status',
    'tools.brotli_checker.description' => 'Check if Brotli compression is enabled for a site.',
    ...
    'tools.duplicate_lines_remover.name' => 'Duplicate Line Remover',
    'tools.duplicate_lines_remover.description' => 'Remove repeated lines from your text.',
    ...
    'tools.text_to_speech.description' => 'Convert written text into spoken audio.',
    'tools.text_to_speech.meta_keywords' => '',
    'tools.text_to_speech.language_code' => 'Language code',
    'tools.text_to_speech.extra_content' => '',

    'tools.idn_punnycode_converter.name' => 'IDN/Punycode Converter',
    'tools.idn_punnycode_converter.description' => 'Switch between IDN and Punycode formats.',
    ...
    'tools.json_validator_beautifier.name' => 'JSON Validator & Formatter',
    'tools.json_validator_beautifier.description' => 'Check and format your JSON for readability.',
    ...
    'tools.qr_code_reader.name' => 'QR Code Scanner',
    'tools.qr_code_reader.description' => 'Scan and read data from any QR code image.',
    ...
    'tools.barcode_reader.name' => 'Barcode Scanner',
    'tools.barcode_reader.description' => 'Scan and read data from any barcode image.',
    ...
    'tools.meta_tags_checker.name' => 'Meta Tag Viewer',
    'tools.meta_tags_checker.description' => 'View and check meta tags for any website.',
    ...
    'tools.exif_reader.name' => 'Exif Data Reader',
    'tools.exif_reader.description' => 'Extract image metadata from your photos.',
    ...
    'tools.color_picker.description' => 'Pick a color and get its code in any format.',
    'tools.color_picker.meta_keywords' => '',
    'tools.color_picker.color' => 'Color',
    'tools.color_picker.extra_content' => '',

    'tools.sql_beautifier.name' => 'SQL Beautifier',
    'tools.sql_beautifier.description' => 'Format and clean up your SQL code.',
    ...
    'tools.html_entity_converter.description' => 'Encode or decode HTML entities easily.',
    ...
    'tools.binary_converter.description' => 'Convert text to binary and back.',
    ...
    'tools.hex_converter.description' => 'Convert text to hexadecimal and back.',
    ...
    'tools.ascii_converter.description' => 'Convert text to ASCII and back.',
    ...
    'tools.decimal_converter.description' => 'Convert text to decimal and back.',
    ...
    'tools.octal_converter.description' => 'Convert text to octal and back.',
    ...
    'tools.morse_converter.name' => 'Morse Code Converter',
    'tools.morse_converter.description' => 'Convert text to Morse code and back.',
    ...
    'tools.number_to_words_converter.name' => 'Number to Words',
    'tools.number_to_words_converter.description' => 'Spell out any number in words.',
    ...
    'tools.json_to_php_array_converter.name' => 'JSON to PHP Array',
    'tools.json_to_php_array_converter.description' => 'Convert JSON data to PHP array format.',
    ...
    'tools.mailto_link_generator.name' => 'Mailto Link Builder',
    'tools.mailto_link_generator.description' => 'Create mailto links with custom subject, body, and recipients.',
    ...
    'tools.youtube_thumbnail_downloader.name' => 'YouTube Thumbnail Saver',
    'tools.youtube_thumbnail_downloader.description' => 'Download thumbnails from any YouTube video.',
    ...
    'tools.safe_url_checker.description' => 'Check if a URL is safe to visit.',
    ...
    'tools.utm_link_generator.name' => 'UTM Link Builder',
    'tools.utm_link_generator.description' => 'Create trackable links with UTM parameters.',
    ...
    'tools.whatsapp_link_generator.name' => 'WhatsApp Link Builder',
    'tools.whatsapp_link_generator.description' => 'Create WhatsApp message links easily.',
    ...
    'tools.youtube_timestamp_link_generator.name' => 'YouTube Timestamp Link',
    'tools.youtube_timestamp_link_generator.description' => 'Create YouTube links with a custom start time.',
    ...
    'tools.google_cache_checker.name' => 'Google Cache Status',
    'tools.google_cache_checker.description' => 'See if a website is cached by Google.',
    ...
    'tools.url_redirect_checker.name' => 'URL Redirect Tracker',
    'tools.url_redirect_checker.description' => 'Follow redirects for any URL step-by-step.',
    ...
    'tools.image_optimizer.description' => 'Reduce image size while keeping quality.',
    ...
    'tools.text_separator.description' => 'Split or join text by lines, commas, or spaces.',
    ...
    'tools.email_extractor.description' => 'Find and extract emails from any text.',
    ...
    'tools.url_extractor.description' => 'Find and extract URLs from any text.',
    'tools.url_extractor.meta_keywords' => '',
    'tools.url_extractor.result.count' => 'Count',
    'tools.url_extractor.extra_content' => '',

    'tools.text_size_calculator.name' => 'Text Size Checker',
    'tools.text_size_calculator.description' => 'Check the size of your text in bytes, KB, or MB.',
    'tools.text_size_calculator.meta_keywords' => '',
    'tools.text_size_calculator.result' => 'Size',
    'tools.text_size_calculator.extra_content' => '',

    'tools.paypal_link_generator.name' => 'PayPal Link Builder',
    'tools.paypal_link_generator.description' => 'Create PayPal payment links quickly.',
    ...
    'tools.bbcode_to_html.name' => 'BBCode to HTML Converter',
    'tools.bbcode_to_html.description' => 'Change BBCode to HTML easily.',
    ...
    'tools.html_tags_remover.name' => 'HTML Tag Remover',
    'tools.html_tags_remover.description' => 'Remove all HTML tags from your text.',
    'tools.html_tags_remover.meta_keywords' => '',
    'tools.html_tags_remover.extra_content' => '',

    'tools.celsius_to_fahrenheit.name' => 'Celsius to Fahrenheit Converter',
    'tools.celsius_to_fahrenheit.description' => 'Convert Celsius to Fahrenheit instantly.',
    ...
    'tools.celsius_to_kelvin.name' => 'Celsius to Kelvin Converter',
    'tools.celsius_to_kelvin.description' => 'Convert Celsius to Kelvin instantly.',
    ...
    'tools.fahrenheit_to_celsius.name' => 'Fahrenheit to Celsius Converter',
    'tools.fahrenheit_to_celsius.description' => 'Convert Fahrenheit to Celsius instantly.',
    ...
    'tools.fahrenheit_to_kelvin.name' => 'Fahrenheit to Kelvin Converter',
    'tools.fahrenheit_to_kelvin.description' => 'Convert Fahrenheit to Kelvin instantly.',
    ...
    'tools.kelvin_to_celsius.name' => 'Kelvin to Celsius Converter',
    'tools.kelvin_to_celsius.description' => 'Convert Kelvin to Celsius instantly.',
    ...
    'tools.kelvin_to_fahrenheit.name' => 'Kelvin to Fahrenheit Converter',
    'tools.kelvin_to_fahrenheit.description' => 'Convert Kelvin to Fahrenheit instantly.',
    ...
    'tools.kilometers_per_hour_to_miles_per_hour.name' => 'Kph to Mph Converter',
    'tools.kilometers_per_hour_to_miles_per_hour.description' => 'Convert Kph to Mph instantly.',
    ...
    'tools.miles_per_hour_to_kilometers_per_hour.name' => 'Mph to Kph Converter',
    'tools.miles_per_hour_to_kilometers_per_hour.description' => 'Convert Mph to Kph instantly.',
    ...
    'tools.number_to_roman_numerals.description' => 'Convert numbers to Roman numerals easily.',
    ...
    'tools.roman_numerals_to_number.description' => 'Convert Roman numerals to numbers easily.',
    ...
    'tools.unix_timestamp_to_date.description' => 'Convert Unix timestamps to readable dates.',
    ...
    'tools.date_to_unix_timestamp.description' => 'Convert dates to Unix timestamp format.',
    ...
    'tools.signature_generator.name' => 'Signature Maker',
    'tools.signature_generator.description' => 'Create and download your own signature.',
